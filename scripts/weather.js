...
const appid = "&appid=87d222e5fc98d398896025d26c1d3db3";

const curURL = 'https://api.openweathermap.org/data/2.5/weather?q=Carlsbad' +units +appid;
const forURL = 'https://api.openweathermap.org/data/2.5/forecast/daily?lat={lat}&lon={lon}&cnt={cnt}&appid={API key}' +units +appid;
